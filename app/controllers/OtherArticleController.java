...
public class OtherArticleController extends Controller {
    ...
    public Result getAllOtherArticles(){
        ...
        try {
            ...
            ResultSet resultSet = connection.prepareStatement("SELECT * FROM articles INNER JOIN otherarticles on articles.article_id = otherarticles.otherarticle_id LEFT JOIN purchase on articles.article_id  = purchase.article_id WHERE purchase.purchase_id IS NULL ORDER BY articles.article_id;").executeQuery();
